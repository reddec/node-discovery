...
(function() {
  var EventEmitter, INTERVAL, METHOD_ECHO, METHOD_FIND, METHOD_FORCE_FIND, MULTICAST_IP, MULTICAST_PORT, Service, dgram,
  ...
  Service = (function(_super) {
    ...
    * @param {number} Sending interval
    ...
    function Service(name, port, ip, interval) {
      ...
      this.forceByName = __bind(this.forceByName, this);
    ...
    * Listener for incoming UDP messages
    ...
    Service.prototype.on_message = function(msg, rinfo) {
      ...
      if (msg.method === METHOD_FIND && msg.query === this.name) {
        return this.sendAbout();
      }
    ...
    * @return {Service} itself
    ...
    Service.prototype.forceByName = function(name) {
      var msg;
      msg = {
        method: METHOD_FIND,
        name: this.name,
